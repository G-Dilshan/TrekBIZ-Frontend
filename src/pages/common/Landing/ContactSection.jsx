              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">+94 78 804 2589</p>
                    <p className="opacity-90">+94 78 491 2424</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">anlaptopsolution@gmail.com</p>
                    <p className="opacity-90">robotrek.trekbiz@gmail.com</p>
                  </div>
                </div>
