...
const FeatureComparisonTable = () => {
  ...
  const featureCategories = [
    ...
    {
      name: 'Advanced TrekBIZ Features',
      features: [
    ...
    {
      name: 'Enterprise TrekBIZ Features',
      features: [
        ...
        <thead>
          <tr className="bg-gray-50">
            ...
            <th className="py-4 px-6 text-center text-gray-600 font-medium w-1/5">
              ...
              <div className="text-sm font-normal">Rs.5000/month</div>
            </th>
            <th className="py-4 px-6 text-center text-gray-600 font-medium w-1/5 bg-primary/5">
              ...
              <div className="text-sm font-normal">Rs.10,000/month</div>
            </th>
            <th className="py-4 px-6 text-center text-gray-600 font-medium w-1/5">
